"""
Django settings for mtg_portal project.

Base settings - extended by local.py and production.py
"""
...
WSGI_APPLICATION = 'mtg_portal.wsgi.application'
